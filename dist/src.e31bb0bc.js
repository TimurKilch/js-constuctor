...
var model = [new _blocks.TitleBlock('Конструктор сайтов на чистом JS', {
  ...
  alt: 'Its image'
}), new _blocks.TextBlock('Небольшой проект с курсов', {
  tag: "h2",
  styles: {
    padding: '1.5rem 0',
    display: 'flex',
...
}), new _blocks.ColumnsBlock(['Приложение на чистом JS', 'Принципы SOLID и ООП', 'Без использования библиотек'], {
  styles: {
    padding: '1.5rem 0',
    display: 'flex',
    'justify-content': 'center',
